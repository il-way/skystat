...
import com.ilway.skystat.framework.parser.metar.entry.TemperatureRegexParser;
...
public class TemperatureTest {
  ...
  ReportParser<Temperature> parser = new TemperatureRegexParser();
  ...
  public void 양의_온도쌍을_가진_메타_파싱에_성공해야한다() {
    ...
    Temperature expected = Temperature.of(18, TemperatureUnit.CELSIUS);
  ...
  public void 양의_온도와_음의_이슬점을_갖는_메타_파싱에_성공해야한다() {
    ...
    Temperature t = parser.parse(rawText);
    Temperature expected = Temperature.of(10, TemperatureUnit.CELSIUS);
  ...
  public void 음의_온도와_양의_이슬점을_갖는_메타_파싱에_성공해야한다() {
    ...
    Temperature t = parser.parse(rawText);
    Temperature expected = Temperature.of(-17, TemperatureUnit.CELSIUS);
  ...
  public void 음의_온도쌍을_갖는_메타_파싱에_성공해야한다() {
    ...
    Temperature t = parser.parse(rawText);
    Temperature expected = Temperature.of(-22, TemperatureUnit.CELSIUS);
